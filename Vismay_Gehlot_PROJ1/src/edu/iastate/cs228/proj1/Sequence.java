...
public class Sequence
{
  ...
  /**
   ...
   {@link java.lang.IllegalArgumentException} with the message {@code "Invalid 
   sequence letter for class X"} where {@code X} denotes {@code  'edu.iastate.cs228.proj1.Sequence'} 
   or the name of a subclass of which an object is created. Examples are given in the project 
   description page to illustrate what exactly is denoted by {@code X} after the subclasses of class
   {@code Sequence} are defined. Note that the length of the field {@code seqarr} is equal to the 
   length of the array {@code sarr}. This constructor should be implemented in such a way that it 
   is unnecessary to have more than one line of code in the body of the constructor of any subclass 
   of this class.
  ...
  */  
  public Sequence(char[] sarr)
  {
	  ...
	  for( int i = 0; i < sarr.length; i++)
	  {
		  ...
		  {
			  System.out.println("Invalid sequence letter for class" + this.getClass());
  ...
  */
  public boolean equals(Object obj)
  {
	  ...
	  if (((Sequence)obj).seqLength() != seqLength())
	  {
		  return false;
	  }
	  ...
	  {
		  if (((Sequence)obj).getSeq()[i] != seqarr[i])
		  {
			  return false;
		  }
	  }
